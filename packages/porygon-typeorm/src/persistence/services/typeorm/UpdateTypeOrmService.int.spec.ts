...
describe(UpdateTypeOrmService.name, () => {
  ...
  let updateTypeOrmAdapter: UpdateTypeOrmService<ModelTest, QueryTest>;
  ...
  beforeAll(async () => {
    ...
    const datasourceOptions: DataSourceOptions = {
      database: path.resolve('tmp', 'typeorm', 'UpdateTypeOrmAdapter.sqlite'),
      entities: [ModelTest],
      logging: false,
      type: 'sqlite',
    };
    ...
    updateTypeOrmAdapter = new UpdateTypeOrmService<ModelTest, QueryTest>(
      modelTestRepository,
      updateQueryToFindQueryTypeOrmConverter,
      updateQueryToSetQueryTypeOrmConverter,
    );
